public class Permission {
     ...
     */
    public static void checkClassName(String classType){
            if ( classType.toLowerCase().equals("math") || classType.toLowerCase().equals("science") );
            else throw new RuntimeException(classType + " is not allowed!");
